    ...
    function getFeedList(pape){
      ...
      $.ajax({
    	...
    	for(let i=0; i < resp.length; i++){
    	 	...
    	 	let contentsDiv = $("<div class='col-sm-6 col-lg-4 cafeinimg'><a class='lightbox' href='/cafein/selectBySeq?cafein_seq="+resp[i].cafein_seq+"'><img src='/resources/cafein/"+ resp[i].sys_name +"'>");
